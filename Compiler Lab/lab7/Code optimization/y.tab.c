...
{
       0,   192,   192,   194,   197,   197,   200,   205,   210,   214,
     219,   229,   239,   248,   258,   261,   266
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "INT", "ID",
  "MAIN", "'+'", "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "'='",
  "';'", "$accept", "start", "body", "stmtlist", "stmt", "expr", YY_NULLPTR
};
...
{
       2,     5,    19,     9,   -18,    11,    15,    12,    14,   -18,
      15,     7,   -18,   -18,     6,    13,    16,    -7,   -18,   -18,
     -18,    10,    10,    10,    10,   -18,   -18,   -18,   -18,     8,
       8,   -18,   -18
};
...
{
       0,     0,     0,     0,     1,     0,     5,     0,     0,     3,
       5,     0,     2,     4,    15,    16,    14,     0,     7,     6,
       8,     0,     0,     0,     0,     9,    15,    16,    14,    10,
      11,    12,    13
};
...
{
      21,    22,    23,    24,    29,    30,    31,    32,     1,    25,
      14,    15,    16,    26,    27,    28,     3,    23,    24,     4,
       7,     5,    18,     0,     6,     0,     0,    11,    12,    19,
      13,     0,    20
};

static const yytype_int8 yycheck[] =
{
       7,     8,     9,    10,    21,    22,    23,    24,     6,    16,
       3,     4,     5,     3,     4,     5,    11,     9,    10,     0,
       5,    12,    16,    -1,    13,    -1,    -1,    15,    14,    16,
      10,    -1,    16
};
...
{
       0,     6,    18,    11,     0,    12,    13,     5,    19,    20,
      21,    15,    14,    20,     3,     4,     5,    22,    16,    16,
      16,     7,     8,     9,    10,    16,     3,     4,     5,    22,
      22,    22,    22
};
...
#line 214 "q2.y"
                  { 
  char * tmp = pop();
  addQuadruple('=',"",tmp,(yyvsp[-3].string)); 
}
#line 1356 "y.tab.c"
    break;
...
#line 266 "q2.y"
      {
  char temp[10];
  sprintf(temp,"%d",(int)(yyvsp[0].dval));
  push(temp);
}
#line 1440 "y.tab.c"
    break;
