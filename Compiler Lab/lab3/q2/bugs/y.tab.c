...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_vars = 21,                      /* vars  */
  YYSYMBOL_vard = 22,                      /* vard  */
...
static const yytype_uint8 yyrline[] =
{
      ...
      96,   104,   104,   107,   121,   135,   139,   147,   157,   167,
     178,   187
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "TYPE", "ID",
  "MAIN", "'+'", "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'",
  "','", "'='", "$accept", "start", "body", "vars", "vard", "varlist",
...
#line 68 "q2.y"
                        {                int i;
                                         ...
                                         enter_to_symb((yyvsp[0].string),(yyvsp[-3].string),0);
                        }
#line 1205 "y.tab.c"
    break;

  case 8: /* varlist: ID '=' NUMBER  */
#line 76 "q2.y"
                         {
                     ...
                     int i;
                                         ...
                                         enter_to_symb((yyvsp[-2].string),(yyvsp[-3].string),(yyvsp[0].dval));
                                         }
#line 1219 "y.tab.c"
    break;

  case 9: /* varlist: varlist ',' ID '=' NUMBER  */
#line 86 "q2.y"
                           {
                                         ...
                                         enter_to_symb((yyvsp[-2].string),(yyvsp[-5].string),(yyvsp[0].dval));
                                         }
#line 1233 "y.tab.c"
    break;
...
#line 96 "q2.y"
                        {                int i=search_symbol((yyvsp[0].string));
                                         ...
                                         enter_to_symb((yyvsp[0].string),(yyvsp[-1].string),0);
                         }
#line 1244 "y.tab.c"
    break;

  case 13: /* stmt: ID '=' NUMBER ';'  */
#line 107 "q2.y"
                         {
